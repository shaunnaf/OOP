...
Протестируйте свой код с помощью [юнит-тестов](#). При сдаче задания преподавателю объясните, как выбранный набор тестов обеспечивает корректность вашего алгоритма.  
